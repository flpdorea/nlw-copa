    ...
    <div className='max-w-[1124px] mx-auto grid grid-cols-2 items-center gap-28 h-screen'>
      <main>
        ...
        <form onSubmit={createPool} className='mt-10 flex gap-2'>
          <input type="text" required placeholder="Qual nome do seu bolão?" className='flex-1 px-6 py-4 rounded bg-gray-800 border border-gray-600 text-sm text-gray-100' onChange={event => setPoolTitle(event.target.value)} value={poolTitle}/>
      ...
      <Image src={appPreviewImage} alt="Dois celulares com prévia do app mobile." quality={100} />
    </div>
  )
}
